...
export default async function CodeWindow() {
  ...
  return (
    <article className="w-full moving-gradient p-1 md:rounded-lg md:max-w-3xl rounded-lg mx-auto">
      <header className="bg-bg-secondary flex items-center align-middle rounded-t-lg">
      ...
      <main className="md:text-lg text-sm ">
        <div
